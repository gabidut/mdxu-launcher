...
document.addEventListener('DOMContentLoaded', prepareServerSelectionList)
...
async function populateServerListings() {
    ...
    document.querySelector('.server_selection').innerHTML = ''
    ...
    for (const serv of servers) {
        ...
        button.classList.add('serverListing')
        button.setAttribute('servid', serv.rawServer.id)
        if (serv.rawServer.id === giaSel) {
            button.setAttribute('selected', '')
        }
        let img = document.createElement('img')
        img.classList.add('serverListingImg')
        img.src = serv.rawServer.icon
...
async function prepareServerSelectionList() {
    console.log('Preparing server selection list...')
